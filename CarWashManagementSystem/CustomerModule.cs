...
namespace CarWashManagementSystem
{
    public partial class CustomerModule : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (repository.CheckField(txtAddress.Text, txtPhone.Text, txtName.Text, txtCarNo.Text, txtCarModel.Text))
                {
                    ...
                    {
                        repository.AddCustomer(cbCarType.SelectedValue.ToString(), txtName.Text, txtPhone.Text, txtCarNo.Text, txtCarModel.Text, txtAddress.Text, txtCarModel.Text);
